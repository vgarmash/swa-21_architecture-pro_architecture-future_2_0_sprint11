...
1. Опишите целевую событийную архитектуру, построив Event Storming-диаграмму или аналогичную схему. На диаграмме отразите основные события, публикуемые доменами. Например: «Создан кредитный договор», «Зарегистрирован новый пациент» или «Пройдено исследование ИИ». Укажите, какие домены выступают источниками этих событий, а какие — подписчиками.
1. Обоснуйте выбор событийного подхода, пояснив, какие преимущества он принесёт компании «Будущее 2.0». Опишите, как переход на интеграцию через события повысит гибкость, масштабируемость и скорость реакции системы по сравнению с текущей шиной Camel и DWH.
...
Обратите внимание, что результат сохранён в папке /Task4Advanced/ с артефактами:
